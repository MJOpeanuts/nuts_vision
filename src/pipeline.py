...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python pipeline.py --model smd_comp.pt --image board.jpg
  python pipeline.py --model smd_comp.pt --image-dir images/
  python pipeline.py --model smd_comp.pt --image board.jpg --conf 0.5
        """
    )
